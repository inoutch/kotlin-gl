...
expect object gl {
    ...
    fun attachShader(program: GLuint, shader: GLuint)
    fun bindAttribLocation(program: GLuint, index: GLuint, name: String)
    fun bindBuffer(target: GLenum, buffer: GLuint)
    fun bindFramebuffer(target: GLenum, framebuffer: GLuint)
    fun bindRenderbuffer(target: GLenum, renderbuffer: GLuint)
    fun bindTexture(target: GLenum, texture: GLuint)
    fun blendColor(red: GLfloat, green: GLfloat, blue: GLfloat, alpha: GLfloat)
    ...
    fun blendFuncSeparate(sfactorRGB: GLenum, dfactorRGB: GLenum, sfactorAlpha: GLenum, dfactorAlpha: GLenum)
    fun bufferData(target: GLenum, data: IntArray, usage: GLenum)
    fun bufferData(target: GLenum, data: IntArray, size: GLint, usage: GLenum)
    fun bufferData(target: GLenum, data: FloatArray, usage: GLenum)
    fun bufferData(target: GLenum, data: FloatArray, size: GLint, usage: GLenum)
    fun bufferData(target: GLenum, data: ByteArray, usage: GLenum)
    fun bufferData(target: GLenum, data: ByteArray, size: GLint, usage: GLenum)
    fun bufferSubData(target: GLenum, offset: GLintptr, data: IntArray)
    fun bufferSubData(target: GLenum, offset: GLintptr, data: IntArray, size: GLint)
    fun bufferSubData(target: GLenum, offset: GLintptr, data: FloatArray)
    fun bufferSubData(target: GLenum, offset: GLintptr, data: FloatArray, size: GLint)
    fun bufferSubData(target: GLenum, offset: GLintptr, data: ByteArray)
    fun bufferSubData(target: GLenum, offset: GLintptr, data: ByteArray, size: GLint)
    fun checkFramebufferStatus(target: GLenum): GLenum
    fun clear(mask: GLbitfield)
    fun clearColor(red: GLfloat, green: GLfloat, blue: GLfloat, alpha: GLfloat)
    fun clearDepthf(d: GLfloat)
    fun clearStencil(s: GLint)
    fun colorMask(red: GLboolean, green: GLboolean, blue: GLboolean, alpha: GLboolean)
    fun compileShader(shader: GLuint)
    fun compressedTexImage2D(target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, data: ByteArray)
    fun compressedTexSubImage2D(target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, data: ByteArray)
    ...
    fun createProgram(): GLuint
    fun createShader(type: GLenum): GLuint
    fun cullFace(mode: GLenum)
    fun deleteBuffers(buffers: IntArray)
    fun deleteFramebuffers(framebuffers: IntArray)
    fun deleteProgram(program: GLuint)
    fun deleteRenderbuffers(renderbuffers: IntArray)
    fun deleteShader(shader: GLuint)
    fun deleteTextures(textures: IntArray)
    fun depthFunc(func: GLenum)
    fun depthMask(flag: GLboolean)
    fun depthRangef(n: GLfloat, f: GLfloat)
    fun detachShader(program: GLuint, shader: GLuint)
    fun disable(cap: GLenum)
    fun disableVertexAttribArray(index: GLuint)
    fun drawArrays(mode: GLenum, first: GLint, count: GLsizei)
    fun drawElements(mode: GLenum, indices: IntArray)
    fun enable(cap: GLenum)
    fun enableVertexAttribArray(index: GLuint)
    fun finish()
    fun flush()
    fun framebufferRenderbuffer(target: GLenum, attachment: GLenum, renderbuffertarget: GLenum, renderbuffer: GLuint)
    fun framebufferTexture2D(target: GLenum, attachment: GLenum, textarget: GLenum, texture: GLuint, level: GLint)
    fun frontFace(mode: GLenum)
    fun genBuffers(n: GLsizei): IntArray
    fun generateMipmap(target: GLenum)
    fun genFramebuffers(n: GLsizei): IntArray
    fun genRenderbuffers(n: GLsizei): IntArray
    fun genTextures(n: GLsizei): IntArray
    fun getActiveAttribSize(program: GLuint): GLint
    fun getActiveAttrib(program: GLuint, index: GLuint): Pair<String, GLint>
    fun getActiveUniformSize(program: GLuint): GLint
    fun getActiveUniform(program: GLuint, index: GLuint): Pair<String, GLint>
    fun getAttachedShaders(program: GLuint): IntArray
    fun getAttribLocation(program: GLuint, name: String): GLint
    fun getBooleanv(pname: GLenum): Boolean
    fun getBufferParameteriv(target: GLenum, pname: GLenum): GLint
    fun getError(): GLenum
    fun getFloatv(pname: GLenum): GLfloat
    ...
    fun getTexParameterfv(target: GLenum, pname: GLenum): GLfloat
    fun getTexParameteriv(target: GLenum, pname: GLenum): GLint
    fun getUniformfv(program: GLuint, location: GLint): GLfloat
    fun getUniformiv(program: GLuint, location: GLint): GLint
    fun getUniformLocation(program: GLuint, name: String): GLint
    fun getVertexAttribfv(index: GLuint, pname: GLenum): GLfloat
    fun getVertexAttribiv(index: GLuint, pname: GLenum): GLint
//    fun getVertexAttribPointer(index: GLuint, pname: GLenum): Long
    fun hint(target: GLenum, mode: GLenum)
    fun isBuffer(buffer: GLuint): GLboolean
    fun isEnabled(cap: GLenum): GLboolean
    fun isFramebuffer(framebuffer: GLuint): GLboolean
    fun isProgram(program: GLuint): GLboolean
    fun isRenderbuffer(renderbuffer: GLuint): GLboolean
    fun isShader(shader: GLuint): GLboolean
    fun isTexture(texture: GLuint): GLboolean
    fun lineWidth(width: GLfloat)
    fun linkProgram(program: GLuint)
    fun pixelStorei(pname: GLenum, param: GLint)
    fun polygonOffset(factor: GLfloat, units: GLfloat)
    fun readPixelsi(x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum): IntArray
    fun readPixelsf(x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum): FloatArray
    fun releaseShaderCompiler()
    fun renderbufferStorage(target: GLenum, internalformat: GLenum, width: GLsizei, height: GLsizei)
    fun sampleCoverage(value: GLfloat, invert: GLboolean)
    fun scissor(x: GLint, y: GLint, width: GLsizei, height: GLsizei)
    fun shaderBinary(shaders: IntArray, binaryformat: GLenum, binary: ByteArray)
    fun shaderSource(shader: GLuint, string: String)
    ...
    fun stencilOpSeparate(face: GLenum, sfail: GLenum, dpfail: GLenum, dppass: GLenum)
    fun texImage2D(target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type: GLenum, pixels: ByteArray)
    fun texParameterf(target: GLenum, pname: GLenum, param: GLfloat)
    fun texParameterfv(target: GLenum, pname: GLenum, params: FloatArray)
    fun texParameteri(target: GLenum, pname: GLenum, param: GLint)
    fun texParameteriv(target: GLenum, pname: GLenum, params: IntArray)
    fun texSubImage2D(target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, pixels: ByteArray)
    fun uniform1f(location: GLint, v0: GLfloat)
    fun uniform1fv(location: GLint, value: FloatArray)
    fun uniform1i(location: GLint, v0: GLint)
    fun uniform1iv(location: GLint, value: IntArray)
    fun uniform2f(location: GLint, v0: GLfloat, v1: GLfloat)
    fun uniform2fv(location: GLint, value: FloatArray)
    fun uniform2i(location: GLint, v0: GLint, v1: GLint)
    fun uniform2iv(location: GLint, value: IntArray)
    fun uniform3f(location: GLint, v0: GLfloat, v1: GLfloat, v2: GLfloat)
    fun uniform3fv(location: GLint, value: FloatArray)
    fun uniform3i(location: GLint, v0: GLint, v1: GLint, v2: GLint)
    fun uniform3iv(location: GLint, value: IntArray)
    fun uniform4f(location: GLint, v0: GLfloat, v1: GLfloat, v2: GLfloat, v3: GLfloat)
    fun uniform4fv(location: GLint, value: FloatArray)
    fun uniform4i(location: GLint, v0: GLint, v1: GLint, v2: GLint, v3: GLint)
    fun uniform4iv(location: GLint, value: IntArray)
    fun uniformMatrix2fv(location: GLint, transpose: GLboolean, value: FloatArray)
    fun uniformMatrix3fv(location: GLint, transpose: GLboolean, value: FloatArray)
    fun uniformMatrix4fv(location: GLint, transpose: GLboolean, value: FloatArray)
    fun useProgram(program: GLuint)
    fun validateProgram(program: GLuint)
    fun vertexAttrib1f(index: GLuint, x: GLfloat)
    fun vertexAttrib1fv(index: GLuint, v: FloatArray)
    fun vertexAttrib2f(index: GLuint, x: GLfloat, y: GLfloat)
    fun vertexAttrib2fv(index: GLuint, v: FloatArray)
